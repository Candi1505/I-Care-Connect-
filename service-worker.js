const CACHE="florence-shell-20260802-7";
const SHELL=["./","./index.html","./styles.css?v=20260801-1","./config.js","./app.js?v=20260802-1","./operations.js?v=20260802-1","./staff-management.js?v=20260801-1","./setup-code-display.js?v=20260802-1","./portal-participant-label.js?v=20260802-1","./push-notifications.js?v=20260802-2","./portal-care-plan.js?v=20260802-1","./medication-prn-fix.js?v=20260802-1","./sil.html","./sil.css?v=20260731-1","./sil.js?v=20260801-4","./manifest.webmanifest","./florence-icon.svg"];

...
function renderGovernance(){
 ...
 q("#credential-list").innerHTML=ops.credentials.map(x=>card(x.credential_type,`${worker(x.staff_id)} · expires ${x.expiry_date||"not set"} · ${x.status}`,x.notes||"")).join("")||B().empty("No staff credentials.");

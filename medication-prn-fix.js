...
const style=document.createElement("style");style.textContent=`#prn-pain-assessment{margin:14px 0;min-width:0;max-width:100%;overflow:hidden}.prn-pain-head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.prn-pain-head p{margin:.3rem 0 0}.prn-face-fieldset{margin-top:12px;min-width:0}.prn-face-scale{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:7px}.prn-face-choice{display:flex;min-width:0;flex-direction:column;align-items:center;justify-content:center;gap:3px;padding:10px 4px;border:2px solid rgba(95,143,114,.25);border-radius:14px;background:#fff;color:#244f38}.prn-face-choice.selected{border-color:#3f7655;background:#eaf5ed;box-shadow:0 0 0 2px rgba(63,118,85,.12)}.prn-face{font-size:1.8rem}.prn-face-choice strong{font-size:.72rem;line-height:1.15;text-align:center}.prn-face-choice small{font-size:.7rem}.prn-observation-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px 12px;margin-top:8px;min-width:0}.prn-observation-grid label{display:flex;gap:9px;align-items:flex-start;min-width:0;margin:0;padding:8px 0;font-size:.9rem;line-height:1.35;overflow-wrap:anywhere}.prn-observation-grid input[type="checkbox"]{appearance:auto!important;flex:0 0 24px!important;width:24px!important;min-width:24px!important;max-width:24px!important;height:24px!important;margin:0!important;padding:0!important;accent-color:#5f8f72}@media(max-width:520px){.prn-face-scale{grid-template-columns:repeat(3,1fr)}.prn-observation-grid{grid-template-columns:minmax(0,1fr)}}`;document.head.appendChild(style);
})();

...
require('data-med-tab="Regular"' in index and index.index('data-med-tab="Regular"') < index.index('app.js?v=20260804-session-rpc-1'), "Regular medication tab exists before app handlers initialise")
